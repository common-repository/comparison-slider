<?php
abstract class viewIcs extends baseObjectIcs {
	/* 
	 * @deprecated
	 */
	protected $_tpl = ICS_DEFAULT;
	/*
	...
	public function getPath( $tpl ) {
		$path = '';
		$parentModule = frameIcs::_()->getModule( $this->_code );
	...
	public function getModel( $code = '' ) {
		return frameIcs::_()->getModule( $this->_code )->getController()->getModel($code);
	}
